...
namespace ApiCatalogoJogos
{
    public class Startup
    {
        ...
        // Método chamado em tempo de execução. Use este método para adicionar serviços ao contêiner.
        ...
        {
            if (env.IsDevelopment()) // Verficando o tipo de ambiente que estamos
            {
